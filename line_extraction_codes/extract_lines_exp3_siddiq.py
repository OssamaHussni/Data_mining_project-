...
input_excel = '/Users/ossam/OneDrive/Desktop/Data_mining_project/ChatGPTasSAST-main/Data sets/test_exp3_siddiq_final_labels.xlsx'
output_csv = '/Users/ossam/OneDrive/Desktop/Data_mining_project/siddiq_output_exp3_file.csv'
...
for i, row in df.iterrows():
    ...
    if 'nan' in raw or not raw.strip():  # Handle rows with invalid or empty data
